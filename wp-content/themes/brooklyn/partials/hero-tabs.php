            ...
            <div class="hero-inner" style="text-align:<?php echo ut_return_hero_config('ut_hero_align' , 'center'); ?>;">                
                ...
                <?php if( !empty($ut_main_hero_button) ) : ?>
                        ...
                        <span class="hero-btn-holder">
                            ...
                            <a id="to-about-section" target="<?php echo ut_clean_section_id($ut_main_hero_button_link_target); ?>" href="<?php echo $ut_main_hero_button_target; ?>" class="hero-btn <?php echo $ut_main_hero_button_style; ?>">
