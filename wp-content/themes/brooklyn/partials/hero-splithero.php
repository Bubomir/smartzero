        ...
        <div class="hero-holder ut-split-hero grid-parent grid-100 mobile-grid-100 tablet-grid-100 <?php echo ut_return_hero_config('ut_hero_style' , 'ut-hero-style-1'); ?>">
            <div class="hero-inner" style="text-align:<?php echo ut_return_hero_config('ut_hero_align' , 'center'); ?>;">                
                ...
                <?php if( !empty($ut_catchphrase) ) : ?>
                    <div class="hdb">
                        <span class="hero-description-bottom"><?php echo do_shortcode( ut_translate_meta($ut_catchphrase) ); ?></span>
                    </div>
                <?php endif; ?>
                ...
                <?php if( !empty($ut_main_hero_button) ) : ?>
                    ...
                    <span class="hero-btn-holder">
                        ...
                        <a id="to-about-section" target="<?php echo $ut_main_hero_button_link_target; ?>" href="<?php echo ut_clean_section_id($ut_main_hero_button_target); ?>" class="hero-btn <?php echo $ut_main_hero_button_style; ?>">
                        ...
                        <?php if( ut_return_hero_config('ut_second_hero_button' , 'off') == 'on' ) : ?>
                            ...
                            <a href="<?php echo ut_clean_section_id($ut_second_hero_button_url); ?>" class="hero-second-btn <?php echo $ut_second_hero_button_style; ?>" target="<?php echo $ut_second_hero_button_target; ?>">
