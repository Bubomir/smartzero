...
class FrmAwbrUpdate{
    ...
    function FrmAwbrUpdate(){
        if(!class_exists('FrmUpdatesController') and !class_exists('FrmUpdate')) return;
        
        // Where all the vitals are defined for this plugin
        $this->plugin_nicename      = 'formidable-aweber';
        $this->plugin_name          = 'formidable-aweber/formidable-aweber.php';
        $this->pro_last_checked_store = 'frm_awbr_last_check';
