<div class="wrap">
    ...
    <div class="form-wrap">
        ...
        <div class="inner-sidebar">
            ...
            <div class="inside">
                <div id="major-publishing-actions">
                    ...
                    <input type="submit" name="Submit" value="<?php _e('Submit', 'frmpp') ?>" class="button-primary" />
                    </div>
                    <div class="clear"></div>
                </div>
            </div>
        ...
        <p>
        <input class="button-primary" type="submit" name="Submit" value="<?php _e('Submit', 'frmpp') ?>" />
        </p>
        </div>
        </div>
