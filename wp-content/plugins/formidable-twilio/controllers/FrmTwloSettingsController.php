...
class FrmTwloSettingsController{
    ...
    private static function process_form(){
        ...
        //$errors = $frm_twlo_settings->validate($_POST,array());
        $errors = array();
	...
	public static function migrate_to_2( $atts, $notification ) {
		...
		$new_action = array(
			...
			'post_title'   => __( 'Send Twilio SMS', 'formidable' ),
    ...
    public static function load_form_settings_hooks() {
        ...
        // load hooks for < v2.0
        add_action('frm_additional_form_notification_options', array(__CLASS__, 'options'), 20, 2);
