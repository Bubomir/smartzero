	   ...
	   extract(shortcode_atts(array(
			...
			$skillbar = '<div class="ut-skill '.$class.'">';
				...
				$skillbar .= '<div class="ut-skill-bar">';
					$skillbar .= '<div class="ut-skill-overlay ut-skill-active" data-effecttype="skillbar" data-width="'.$width1.'" '.$color.'>';
        ...
        $player .= '<div id="' . $id . '" class="ut-shortcode-video-wrap ' . $class . '">';
                ...
                if( !empty($poster) ) {
                    ...
                    $player .= '<a class="ut-load-video" data-video="' . trim($url) . '">';
                        ...
                        $player .= '<img alt="'.( !empty($caption) ? $caption : __('Video','ut_shortcodes') ).'" src="' . $poster . '" />';
