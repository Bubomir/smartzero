...
class FrmHrsUpdate{
    ...
    function FrmHrsUpdate(){
        if(!class_exists('FrmUpdatesController') and !class_exists('FrmUpdate')) return;
        
        // Where all the vitals are defined for this plugin
        $this->plugin_nicename      = 'formidable-highrise';
        $this->plugin_name          = 'formidable-highrise/formidable-highrise.php';
        $this->pro_last_checked_store = 'frmhrs_last_check';
    ...
    function queue_old_update($transient, $force=false){
        ...
        //fallback if no addon update include in main plugin
